...
**Causa:** Chromium necesita correr en modo headless sin sandbox.
**Solución:** Remotion ya maneja esto automáticamente, pero si persiste, agrega:

```typescript
// En render-video.ts, en renderMedia options:
chromiumOptions: {
